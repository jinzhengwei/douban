...
<body>
	...
	<div class="oid-things">
	    ...
	    <?php if(is_array($goodInfo)): $i = 0; $__LIST__ = $goodInfo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><div class="list-img clearfix ">
			<img src="/Public/Upload/<?php echo ($v["img"]); ?>" alt="">
			<div class="img-about">
				<p><?php echo ($v["name"]); ?></p>
				<span class="oid-exp"><?php echo ($v["content"]); ?></span>
				<p>
	...
	<div class="oid-things">
	    ...
	    <div class="list-oid clearfix click-piao">
	    	<span>小计</span>
	    	<span><?php echo ($goodInfo["num * $goodInfo"]["price"]); ?></span>
	    	<span>暂无可用优惠券</span>
	    </div>
	</div>
	<div class="oid-things">
